# Write the comment-based HELP for Remove-IntuneConfigurationProfileAssignment
<#
.SYNOPSIS
    Removes an Intune configuration profile assignment.

.DESCRIPTION
    Removes an Intune configuration profile assignment.

.PARAMETER Id
    The id of the configuration profile to remove assignment from.

.PARAMETER GroupId
    The id of the group to remove the configuration profile assignment from.

.PARAMETER Environment
    The environment to connect to. Valid values are Global, USGov, USGovDoD. Default is Global.

.EXAMPLE
    # Remove a configuration profile assignment.
...
.EXAMPLE
    # Remove a configuration profile assignment in the USGov environment.
...
function Remove-IntuneConfigurationProfileAssignment
{
    ...
    process
    {
        ...
        $Assignments = Get-IntuneConfigurationProfileAssignments -Id $id -Environment $Environment
